/*! jQuery UI - v1.9.0pre - 2012-05-31
...
(function (a, b) {
	function c(b, c) {
		...
		return "area" === h ? (e = b.parentNode, f = e.name, !b.href || !f || e.nodeName.toLowerCase() !== "map" ? !1 : (g = a("img[usemap=#" + f + "]")[0], !!g && d(g))) : (/input|select|textarea|button|object/.test(h) ? !b.disabled : "a" === h ? b.href || c : c) && d(b)
	}
	...
	a.extend(a.ui, {
		...
		b.style.borderWidth = "1px", b.style.borderStyle = "solid", b.style.borderTopColor = "red", b.style.borderRightColor = "green", b.style.position = "absolute", b.style.top = "-999px", a.browser.msie && parseInt(a.browser.version, 10) < 8 ? b.className = "ui-icon" : b.style.backgroundImage = "url(data:image/gif;base64,R0lGODlhAQABAID/AMDAwAAAACH5BAEAAAAALAAAAAABAAEAAAEBMgA7)", a(document.body).append(b);
		var c = a.curCSS(b, "backgroundImage");
		a.support.highContrast = a.curCSS(b, "borderTopColor") == a.curCSS(b, "borderRightColor") || c != null && (c == "none" || c == "url(invalid-url:)"), a.support.highContrast && a("body").addClass("ui-helper-highcontrast"), a.browser.msie ? b.outerHTML = "" : document.body.removeChild(b)
	}), a(function () {
		var b = document.body,
...
function (a, b) {
	...
	a.cleanData = function (b) {
		...
		var e = c.call(arguments, 1),
            ...
            h, i;
		for (; f < g; f++)
			for (h in e[f]) i = e[f][h], e[f].hasOwnProperty(h) && i !== b && (d[h] = a.isPlainObject(i) ? a.widget.extend({}, d[h], i) : i);
		return d
		...
		a.fn[d] = function (g) {
			...
			return g = !h && i.length ? a.widget.extend.apply(null, [g].concat(i)) : g, h ? this.each(function () {
				var c, e = a.data(this, f);
				if (!e) return a.error("cannot call methods on " + d + " prior to initialization; " + "attempted to call method '" + g + "'");
				if (!a.isFunction(e[g]) || g.charAt(0) === "_") return a.error("no such method '" + g + "' for " + d + " widget instance");
				c = e[g].apply(e, i);
				if (c !== e && c !== b) return j = c && c.jquery ? j.pushStack(c.get()) : c, !1
			}) : this.each(function () {
				var b = a.data(this, f);
				b ? b.option(g || {})._init() : new e(g, this)
			}), j
		}
	}, a.Widget = function (a, b) { }, a.Widget._childConstructors = [], a.Widget.prototype = {
		widgetName: "widget",
		widgetEventPrefix: "",
		defaultElement: "<div>",
		options: {
		...
		_createWidget: function (b, c) {
			c = a(c || this.defaultElement || this)[0], this.element = a(c), this.options = a.widget.extend({}, this.options, this._getCreateOptions(), b), this.bindings = a(), this.hoverable = a(), this.focusable = a(), c !== this && (a.data(c, this.widgetName, this), a.data(c, this.widgetFullName, this), this._bind({
				remove: "destroy"
		...
		_hoverable: function (b) {
			this.hoverable = this.hoverable.add(b), this._bind(b, {
		...
		_focusable: function (b) {
			this.focusable = this.focusable.add(b), this._bind(b, {
				focusin: function (b) {
	...
	a.widget("ui.draggable", a.ui.mouse, {
		...
		_convertPositionTo: function (b, c) {
			...
			var d = b == "absolute" ? 1 : -1,
                e = this.options,
                f = this.cssPosition == "absolute" && (this.scrollParent[0] == document || !a.contains(this.scrollParent[0], this.offsetParent[0])) ? this.offsetParent : this.scrollParent,
		...
		_generatePosition: function (b) {
			var c = this.options,
                d = this.cssPosition == "absolute" && (this.scrollParent[0] == document || !a.contains(this.scrollParent[0], this.offsetParent[0])) ? this.offsetParent : this.scrollParent,
...
function (a, b) {
	a.widget("ui.resizable", a.ui.mouse, {
		...
		_mouseDrag: function (a) {
			...
			return k = this._respectSize(k, a), this._propagate("resize", a), b.css({
...
function (a, b) {
	a.widget("ui.sortable", a.ui.mouse, {
		...
		_contactContainers: function (b) {
			...
			if (this.containers.length === 1) this.containers[d]._trigger("over", b, this._uiHash(this)), this.containers[d].containerCache.over = 1;
				...
				for (var i = this.items.length - 1; i >= 0; i--) {
					if (!a.contains(this.containers[d].element[0], this.items[i].item[0])) continue;
		...
		_clear: function (b, c) {
			...
			if (!a.contains(this.element[0], this.currentItem[0])) {
				...
				for (var e = this.containers.length - 1; e >= 0; e--) a.contains(this.containers[e].element[0], this.currentItem[0]) && !c && (d.push(function (a) {
					return function (b) {
	...
	a.effects = {
		effect: {}
            ...
            function () {
            	...
            	a.each(["backgroundColor", "borderBottomColor", "borderLeftColor", "borderRightColor", "borderTopColor", "borderColor", "color", "outlineColor"], function (d, e) {
            		a.fx.step[e] = function (a) {
            			a.colorInit || (a.start = c(a.elem, e), a.end = b(a.end), a.colorInit = !0), a.elem.style[e] = "rgb(" + Math.max(Math.min(parseInt(a.pos * (a.end[0] - a.start[0]) + a.start[0], 10), 255), 0) + "," + Math.max(Math.min(parseInt(a.pos * (a.end[1] - a.start[1]) + a.start[1], 10), 255), 0) + "," + Math.max(Math.min(parseInt(a.pos * (a.end[2] - a.start[2]) + a.start[2], 10), 255), 0) + ")"
            		}
            	});
            	var d = {
            		aqua: [0, 255, 255],
            ...
            function () {
            	function e() {
            		...
            		if (b && b.length && b[0] && b[b[0]]) {
            			f = b.length;
            			while (f--) d = b[f], typeof b[d] == "string" && (c[a.camelCase(d)] = b[d])
            		} else
            ...
            function () {
            	function e(c, d, e, f) {
            		a.isPlainObject(c) && (d = c, c = c.effect), c = {
            			effect: c
            		}, d === b && (d = {}), a.isFunction(d) && (f = d, e = null, d = {});
            		if (typeof d == "number" || a.fx.speeds[d]) f = e, e = d, d = {};
            		return a.isFunction(e) && (f = e, e = null), d && a.extend(c, d), e = e || d.duration, c.duration = a.fx.off ? 0 : typeof e == "number" ? e : e in a.fx.speeds ? a.fx.speeds[e] : a.fx.speeds._default, c.complete = f || d.complete, c
            	}
            	...
            	a.extend(a.effects, {
            		...
            		restore: function (a, b) {
            			for (var c = 0; c < b.length; c++) b[c] !== null && a.css(b[c], a.data(d + b[c]))
            		},
            		...
            		effect: function (b, d, f, g) {
            			function m(b) {
            				...
            				var c = a(this),
                                d = h.complete,
                                e = h.mode;
            				(c.is(":hidden") ? e === "hide" : e === "show") ? f() : k.call(c[0], h, f)
            			}
            			var h = e.apply(this, arguments),
                            i = h.mode,
                            j = h.queue,
                            k = a.effects.effect[h.effect],
                            l = !k && c && a.effects[h.effect];
            			return a.fx.off || !k && !l ? i ? this[i](h.duration, h.complete) : this.each(function () {
            				h.complete && h.complete.call(this)
            			}) : k ? j === !1 ? this.each(m) : this.queue(j || "fx", m) : l.call(this, {
            				options: h,
            				duration: h.duration,
            				callback: h.complete,
            				mode: h.mode
    ...
    function (a, b) {
    	...
    	a.effects.effect.blind = function (b, e) {
    		...
    		f.parent().is(".ui-effects-wrapper") ? a.effects.save(f.parent(), g) : a.effects.save(f, g), f.show(), p = a.effects.createWrapper(f).css({
    			overflow: "hidden"
    		}), q = p[k](), r = parseFloat(p.css(l)), n[k] = o ? q : 0, m || (f.css(j ? "bottom" : "right", 0).css(j ? "top" : "left", "auto").css({
    			position: "absolute"
    ...
    function (a, b) {
    	a.effects.effect.bounce = function (b, c) {
    		var d = a(this),
                ...
                m = b.duration / l,
                n = b.easing,
                o = i === "up" || i === "down" ? "top" : "left",
                p = i === "up" || i === "left",
                q, r, s, t = d.queue(),
                u = t.length;
    		(h || g) && e.push("opacity"), a.effects.save(d, e), d.show(), a.effects.createWrapper(d), j || (j = d[o === "top" ? "outerHeight" : "outerWidth"]() / 3), h && (s = {
    			opacity: 1
    		}, s[o] = 0, d.css("opacity", 0).css(o, p ? -j * 2 : j * 2).animate(s, m, n)), g && (j = j / Math.pow(2, k - 1)), s = {}, s[o] = 0;
    ...
    function (a, b) {
    	a.effects.effect.clip = function (b, c) {
    		...
    		a.effects.save(d, e), d.show(), m = a.effects.createWrapper(d).css({
    			overflow: "hidden"
    		}), n = d[0].tagName === "IMG" ? m : d, o = n[j](), g && (n.css(j, 0), n.css(k, o / 2)), l[j] = g ? o : 0, l[k] = g ? 0 : o / 2, n.animate(l, {
    			queue: !1,
    			duration: b.duration,
    			easing: b.easing,
    			complete: function () {
    ...
    function (a, b) {
    	a.effects.effect.drop = function (b, c) {
    		var d = a(this),
                ...
                g = f === "show",
                h = b.direction || "left",
                i = h === "up" || h === "down" ? "top" : "left",
                j = h === "up" || h === "left" ? "pos" : "neg",
                k = {
                	opacity: g ? 1 : 0
                },
                l;
    		a.effects.save(d, e), d.show(), a.effects.createWrapper(d), l = b.distance || d[i === "top" ? "outerHeight" : "outerWidth"]({
    			margin: !0
    		}) / 2, g && d.css("opacity", 0).css(i, j === "pos" ? -l : l), k[i] = (g ? j === "pos" ? "+=" : "-=" : j === "pos" ? "-=" : "+=") + l, d.animate(k, {
    			queue: !1,
    			duration: b.duration,
    			easing: b.easing,
    			complete: function () {
    ...
    function (a, b) {
    	a.effects.effect.explode = function (b, c) {
    		...
    		var d = b.pieces ? Math.round(Math.sqrt(b.pieces)) : 3,
                e = d,
                f = a(this),
    		...
    		for (m = 0; m < d; m++) {
    			...
    			for (n = 0; n < e; n++) o = i.left + n * j, q = n - (e - 1) / 2, f.clone().appendTo("body").wrap("<div></div>").css({
    				position: "absolute",
    				visibility: "visible",
    				left: -n * j,
    				top: -m * k
    ...
    function (a, b) {
    	a.effects.effect.puff = function (b, c) {
    		...
    		var d = a(this),
                e = a.extend(!0, {}, b),
                f = a.effects.setMode(d, b.mode || "effect"),
                g = parseInt(b.percent, 10) || (parseInt(b.percent, 10) === 0 ? 0 : f === "hide" ? 0 : 100),
                h = b.direction || "both",
                i = b.origin,
                j = {
                	height: d.height(),
    		...
    		e.effect = "size", e.queue = !1, e.complete = c, f !== "effect" && (e.origin = i || ["middle", "center"], e.restore = !0), e.from = b.from || (f === "show" ? {
    			height: 0,
    			width: 0
    		} : j), e.to = {
    			height: j.height * k.y,
    		...
    		}, e.fade && (f === "show" && (e.from.opacity = 0, e.to.opacity = 1), f === "hide" && (e.from.opacity = 1, e.to.opacity = 0)), d.effect(e)
    		...
    		var d = a(this),
                ...
                k = a.effects.setMode(d, b.mode || "effect"),
                l = b.restore || k !== "effect",
                m = b.scale || "both",
                n = b.origin || ["middle", "center"],
                o, p, q, r = d.css("position");
    		k === "show" && d.show(), o = {
    			height: d.height(),
    			width: d.width(),
    			outerHeight: d.outerHeight(),
    			outerWidth: d.outerWidth()
    		}, d.from = b.from || o, d.to = b.to || o, q = {
    			from: {
    				y: d.from.height / o.height,
    				x: d.from.width / o.width
    			},
    			to: {
    				y: d.to.height / o.height,
    				x: d.to.width / o.width
    			}
    		};
    		if (m === "box" || m === "both") q.from.y !== q.to.y && (e = e.concat(i), d.from = a.effects.setTransition(d, i, q.from.y, d.from), d.to = a.effects.setTransition(d, i, q.to.y, d.to)), q.from.x !== q.to.x && (e = e.concat(j), d.from = a.effects.setTransition(d, j, q.from.x, d.from), d.to = a.effects.setTransition(d, j, q.to.x, d.to));
    		(m === "content" || m === "both") && q.from.y !== q.to.y && (e = e.concat(h), d.from = a.effects.setTransition(d, h, q.from.y, d.from), d.to = a.effects.setTransition(d, h, q.to.y, d.to)), a.effects.save(d, l ? e : f), d.show(), a.effects.createWrapper(d), d.css("overflow", "hidden").css(d.from), n && (p = a.effects.getBaseline(n, o), d.from.top = (o.outerHeight - d.outerHeight()) * p.y, d.from.left = (o.outerWidth - d.outerWidth()) * p.x, d.to.top = (o.outerHeight - d.to.outerHeight) * p.y, d.to.left = (o.outerWidth - d.to.outerWidth) * p.x), d.css(d.from);
    		if (m === "content" || m === "both") i = i.concat(["marginTop", "marginBottom"]).concat(h), j = j.concat(["marginLeft", "marginRight"]), g = e.concat(i).concat(j), d.find("*[width]").each(function () {
    			var c = a(this),
                    d = {
                    	height: c.height(),
                    	width: c.width()
                    };
    			l && a.effects.save(c, g), c.from = {
    				height: d.height * q.from.y,
    				width: d.width * q.from.x
    			}, c.to = {
    				height: d.height * q.to.y,
    				width: d.width * q.to.x
    			}, q.from.y !== q.to.y && (c.from = a.effects.setTransition(c, i, q.from.y, c.from), c.to = a.effects.setTransition(c, i, q.to.y, c.to)), q.from.x !== q.to.x && (c.from = a.effects.setTransition(c, j, q.from.x, c.from), c.to = a.effects.setTransition(c, j, q.to.x, c.to)), c.css(c.from), c.animate(c.to, b.duration, b.easing, function () {
    		...
    		d.animate(d.to, {
    			...
    			easing: b.easing,
    			complete: function () {
    				d.to.opacity === 0 && d.css("opacity", d.from.opacity), k === "hide" && d.hide(), a.effects.restore(d, l ? e : f), l || (r === "static" ? d.css({
    					position: "relative",
    					top: d.to.top,
    					left: d.to.left
    				}) : a.each(["top", "left"], function (a, b) {
    					d.css(b, function (b, c) {
    						var e = parseInt(c, 10),
                                f = a ? d.to.left : d.to.top;
    						return c === "auto" ? f + "px" : e + f + "px"
    					})
    ...
    function (a, b) {
    	a.effects.effect.slide = function (b, c) {
    		var d = a(this),
                ...
                j = h === "up" || h === "left",
                k, l = {};
    		a.effects.save(d, e), d.show(), k = b.distance || d[i === "top" ? "outerHeight" : "outerWidth"]({
    			margin: !0
    ...
    function (a, b) {
    	var c = 0,
            ...
            e = {},
            f = {};
    	d.height = d.paddingTop = d.paddingBottom = d.borderTopWidth = d.borderBottomWidth = "hide", e.height = e.paddingTop = e.paddingBottom = e.borderTopWidth = e.borderBottomWidth = "show", a.extend(f, e, {
    		accordionHeight: "show"
    	}), a.fx.step.accordionHeight = function (b) {
    		var c = a(b.elem),
                d = c.data("ui-accordion-height");
    		...
    		_create: function () {
    			...
    			this.prevShow = this.prevHide = a(), this.element.addClass("ui-accordion ui-widget ui-helper-reset"), this.headers = this.element.find(d.header).addClass("ui-accordion-header ui-helper-reset ui-state-default ui-corner-all"), this._hoverable(this.headers), this._focusable(this.headers), this.headers.next().addClass("ui-accordion-content ui-helper-reset ui-widget-content ui-corner-bottom"), !d.collapsible && d.active === !1 && (d.active = 0), d.active < 0 && (d.active += this.headers.length), this.active = this._findActive(d.active).addClass("ui-accordion-header-active ui-state-active").toggleClass("ui-corner-all ui-corner-top"), this.active.next().addClass("ui-accordion-content-active"), this._createIcons(), this.originalHeight = this.element[0].style.height, this.refresh(), this.element.attr("role", "tablist"), this.headers.attr("role", "tab").each(function (c) {
    				...
    				"aria-expanded": "true",
    				"aria-hidden": "false"
    			}) : this.headers.eq(0).attr("tabIndex", 0), this._bind(this.headers, {
    				keydown: "_keydown"
    		...
    		_setOption: function (a, b) {
    			...
    			a === "event" && (this.options.event && this.headers.unbind(this.options.event.split(" ").join(".accordion ") + ".accordion"), this._setupEvents(b)), this._super(a, b), a === "collapsible" && !b && this.options.active === !1 && this._activate(0), a === "icons" && (this._destroyIcons(), b && this._createIcons()), a === "disabled" && this.headers.add(this.headers.next()).toggleClass("ui-state-disabled", !!b)
    		},
    		_keydown: function (b) {
    		...
    		refresh: function () {
    			var b = this.options.heightStyle,
    		...
    		_activate: function (b) {
    			...
    			c = c || this.active[0], this._eventHandler({
    				target: c,
    				currentTarget: c,
    		...
    		_toggle: function (a) {
    			var b = a.newContent,
                    c = this.prevShow.length ? this.prevShow : a.oldContent;
    			this.prevShow.add(this.prevHide).stop(!0, !0), this.prevShow = b, this.prevHide = c, this.options.animate ? this._animate(b, c, a) : (c.hide(), b.show(), this._toggleComplete(a)), c.attr({
    				"aria-expanded": "false",
    				"aria-hidden": "true"
    			}).prev().attr({
    				"aria-selected": "false",
    		...
    		_animate: function (a, b, c) {
    			var g, h, i, j = this,
                    ...
                    m = k && l.down || l,
                    n = function () {
                    	a.removeData("ui-accordion-height"), j._toggleComplete(c)
                    };
    			typeof m == "number" && (i = m), typeof m == "string" && (h = m), h = h || m.easing || l.easing, i = i || m.duration || l.duration;
    			if (!b.length) return a.animate(e, i, h, n);
    			if (!a.length) return b.animate(d, i, h, n);
    			g = a.show().outerHeight(), b.animate(d, i, h), a.hide().data("ui-accordion-height", {
    				total: g,
    				toHide: b
    			}).animate(this.options.heightStyle === "content" ? e : f, i, h, n)
    		},
    		...
    		b._trigger = function (a, b, d) {
    			...
    			return e ? (a === "beforeActivate" ? e = c.call(this, "changestart", b, d) : a === "activate" && (e = c.call(this, "change", b, d)), e) : !1
    		}
    	} (jQuery, jQuery.ui.accordion.prototype), function (a, b) {
    		a.extend(b.options, {
    			animate: null,
    		...
    		b._create = function () {
    			var a = this.options;
    			a.animate === null && (a.animated ? a.animated === "slide" ? a.animate = 300 : a.animated === "bounceslide" ? a.animate = {
    				duration: 200,
    				down: {
    ...
    function (a, b) {
    	...
    	a.widget("ui.autocomplete", {
    		...
    		_create: function () {
    			var b, c, d;
    			this.isMultiLine = this.element.is("textarea,[contenteditable]"), this.valueMethod = this.element[this.element.is("input,textarea") ? "val" : "text"], this.element.addClass("ui-autocomplete-input").attr("autocomplete", "off"), this._bind({
    				keydown: function (e) {
    			...
    			}), this._initSource(), this.menu = a("<ul></ul>").addClass("ui-autocomplete").appendTo(this.document.find(this.options.appendTo || "body")[0]).menu({
    				input: a(),
    				role: null
    			}).zIndex(this.element.zIndex() + 1).hide().data("menu"), this._bind(this.menu.element, {
    				...
    				menufocus: function (a, b) {
    					...
    					!1 !== this._trigger("focus", a, {
    						item: c
    					}) ? /^key/.test(a.originalEvent.type) && this._value(c.value) : this.liveRegion.text(c.value)
    				},
    				...
    				role: "status",
    				"aria-live": "polite"
    			}).addClass("ui-helper-hidden-accessible").insertAfter(this.element), a.fn.bgiframe && this.menu.element.bgiframe(), this._bind(this.window, {
    		...
    		_destroy: function () {
    			clearTimeout(this.searching), this.element.removeClass("ui-autocomplete-input").removeAttr("autocomplete").removeAttr("role").removeAttr("aria-autocomplete").removeAttr("aria-haspopup"), this.menu.element.remove(), this.liveRegion.remove()
    		},
    		_setOption: function (a, b) {
    		...
    		_suggest: function (b) {
    			...
    			this._renderMenu(c, b), this.menu.blur(), this.menu.refresh(), c.show(), this._resizeMenu(), c.position(a.extend({
    				of: this.element
    ...
    function (a, b) {
    	...
    	a.widget("ui.button", {
    		...
    		_create: function () {
    			...
    			})), (this.type === "checkbox" || this.type === "radio") && this.element.bind("focus.button", function (a) {
    				self.buttonElement.addClass(m)
    			}).bind("blur.button", function (a) {
    				self.buttonElement.removeClass(m)
    		...
    		_determineButtonType: function () {
    			var a, b, c;
    			this.element.is(":checkbox") ? this.type = "checkbox" : this.element.is(":radio") ? this.type = "radio" : this.element.is("input") ? this.type = "input" : this.type = "button", this.type === "checkbox" || this.type === "radio" ? (a = this.element.parents().last(), b = "label[for='" + this.element.attr("id") + "']", this.buttonElement = a.find(b), this.buttonElement.length || (a = a.length ? a.siblings() : this.element.siblings(), this.buttonElement = a.filter(b), this.buttonElement.length || (this.buttonElement = a.find(b))), this.element.addClass("ui-helper-hidden-accessible"), c = this.element.is(":checked"), c && this.buttonElement.addClass("ui-state-active"), this.buttonElement.prop("aria-pressed", c)) : this.buttonElement = this.element
    		},
    		widget: function () {
    		...
    		_resetButton: function () {
    			...
    			var b = this.buttonElement.removeClass(i),
                    ...
                    f = [];
    			a.support.highContrast || d.primary || d.secondary ? (this.options.text && f.push("ui-button-text-icon" + (e ? "s" : d.primary ? "-primary" : "-secondary")), d.primary && b.prepend("<span class='ui-button-icon-primary ui-icon " + d.primary + "'></span>"), d.secondary && b.append("<span class='ui-button-icon-secondary ui-icon " + d.secondary + "'></span>"), !this.options.text && !a.support.highContrast && (f.push(e ? "ui-button-icons-only" : "ui-button-icon-only"), this.hasTitle || b.attr("title", c))) : f.push("ui-button-text-only"), b.addClass(f.join(" "))
    		}
    	}), a.ui.button.version = "@VERSION", a.widget("ui.buttonset", {
    		options: {
    ...
    function (a) {
    	...
    	a.widget("ui.checkbox", {
    		...
    		destroy: function () {
    			this.boxElement.remove(), this.checkboxElement.after(this.labelElement).end(), this.element.unwrap("<div></div>").unwrap("<div></div>"), a.Widget.prototype.destroy.apply(this, arguments)
    		},
    		_setOption: function (b, c) {
    			b === "disabled" && (this.element.attr("disabled", c), this.checkboxElement[c ? "addClass" : "removeClass"]("ui-checkbox-disabled")), a.Widget.prototype._setOption.apply(this, arguments)
    		}
    	...
    	a.widget("ui.dialog", {
    		...
    		_create: function () {
    			...
    			var b = this,
                    ...
                    g = (b.uiDialog = a("<div>")).addClass(c + d.dialogClass).css({
                    	display: "none",
                    	outline: 0,
                    	zIndex: d.zIndex
                    ...
                    i = (b.uiDialogTitlebar = a("<div>")).addClass("ui-dialog-titlebar  ui-widget-header  ui-corner-all  ui-helper-clearfix").prependTo(g),
                    j = a("<div class='ui-dialog-toolbar'></div>").appendTo(i),
                    k = a("<a href='#'></a>").addClass("ui-dialog-toolbarbutton ui-dialog-titlebar-close  ui-corner-all").attr("role", "button").click(function (a) {
                    	a.preventDefault(), b.close(a)
                    }).appendTo(j);
    			uiDialogTitlebarCloseText = (b.uiDialogTitlebarCloseText = a("<span>")).addClass("ui-icon ui-icon-closethick").text(d.closeText).appendTo(k), uiDialogTitle = a("<span>").addClass("ui-dialog-title").attr("id", f).html(e).prependTo(i), i.find("*").add(i).disableSelection(), this._hoverable(k), this._focusable(k), b._createButtons(d.buttons), d.draggable && a.fn.draggable && b._makeDraggable(), d.resizable && a.fn.resizable && b._makeResizable(), b._isOpen = !1, a.fn.bgiframe && g.bgiframe()
    		},
    		_init: function () {
    		...
    		close: function (b) {
    			if (!this._isOpen) return c;
    			var c = this,
                    d, e;
    			if (!1 === c._trigger("beforeClose", b)) return;
    			return c._isOpen = !1, c.overlay && c.overlay.destroy(), c.uiDialog.unbind("keypress.ui-dialog"), c.options.hide ? c.uiDialog.hide(c.options.hide, function () {
    				c._trigger("close", b)
    		...
    		moveToTop: function (b, c) {
    			var d = this,
                    e = d.options,
                    f;
    			return e.modal && !b || !e.stack && !e.modal ? d._trigger("focus", c) : (e.zIndex > a.ui.dialog.maxZ && (a.ui.dialog.maxZ = e.zIndex), d.overlay && (a.ui.dialog.maxZ += 1, a.ui.dialog.overlay.maxZ = a.ui.dialog.maxZ, d.overlay.$el.css("z-index", a.ui.dialog.overlay.maxZ)), f = {
    		...
    		open: function () {
    			...
    			return e.length || (e = d.find(".ui-dialog-buttonpane :tabbable"), e.length || (e = d)), e.eq(0).focus(), b._isOpen = !0, b._trigger("open"), b
    		},
    		_createButtons: function (b) {
    			...
    			if (d) {
    				var e = a("<div>").addClass("ui-dialog-buttonpane  ui-widget-content ui-helper-clearfix"),
                        f = a("<div>").addClass("ui-dialog-buttonset").appendTo(e);
    			...
    			} else c.uiDialog.removeClass("ui-dialog-buttons")
    		},
    		_makeDraggable: function () {
    			...
    			b.uiDialog.draggable({
    			...
    			}), b.uiDialogTitlebar.attr("tabindex", "0").attr("role", "button").attr("title", "Move dialog").keydown(function (b) {
    				if (jQuery.inArray(b.keyCode, [37, 38, 39, 40]) == -1) return !0;
    				if (this !== b.target) return;
    				var c = a(this),
                        d = c.offset(),
                        e = b.ctrlKey ? 100 : b.shiftKey ? 1 : 20,
                        f, g, h;
    				f = new a.Event("mousedown"), g = new a.Event("mousemove"), h = new a.Event("mouseup"), f.pageX = g.pageX = h.pageX = d.left, f.pageY = g.pageY = h.pageY = d.top, f.which = h.which = 1, g.button = 1;
    				switch (b.keyCode) {
    					case 37:
    						g.pageX = h.pageX = g.pageX - e;
    						break;
    					case 38:
    						g.pageY = h.pageY = g.pageY - e;
    						break;
    					case 39:
    						g.pageX = h.pageX = g.pageX + e;
    						break;
    				...
    				return c.trigger(f), c.trigger(g), c.trigger(h), b.stopPropagation(), !1
    			})
    		},
    		_makeResizable: function (c) {
    			...
    			d.uiDialog.resizable({
    			...
    			}).css("position", f).find(".ui-resizable-se").addClass("ui-icon ui-icon-grip-diagonal-se").attr("tabindex", "0").attr("role", "button").attr("title", "Resize dialog").keydown(function (b) {
    				if (jQuery.inArray(b.keyCode, [37, 38, 39, 40]) == -1) return !0;
    				var c = a(this),
                        d = c.offset(),
                        e = b.ctrlKey ? 100 : b.shiftKey ? 1 : 20,
                        f, g, h, i, j;
    				f = new a.Event("mouseover"), g = new a.Event("mousedown"), h = new a.Event("mousemove"), i = new a.Event("mousemove"), j = new a.Event("mouseup"), f.pageX = g.pageX = h.pageX = i.pageX = j.pageX = d.left, f.pageY = g.pageY = h.pageY = i.pageY = j.pageY = d.top, g.which = j.which = 1, h.button = i.button = 1;
    				switch (b.keyCode) {
    					case 37:
    						h.pageX = i.pageX = j.pageX = g.pageX - e;
    						break;
    					case 38:
    						h.pageY = i.pageY = j.pageY = g.pageY - e;
    						break;
    					case 39:
    						h.pageX = i.pageX = j.pageX = g.pageX + e;
    						break;
    				...
    				return c.trigger(f), c.trigger(g), c.trigger(h), c.trigger(i), c.trigger(j), b.stopPropagation(), !1
    			})
    		},
    		_minHeight: function () {
    			var a = this.options;
...
+c[a] === c[a] && (d[a] = c[a], c[a] = b)
    		...
    		_setOption: function (b, d) {
    			...
    			switch (b) {
    				...
    				case "draggable":
    					...
    					g && !d && (e.uiDialogTitlebar.removeAttr("tabindex").removeAttr("role").removeAttr("title").unbind("keydown"), f.draggable("destroy")), !g && d && e._makeDraggable();
    					break;
    				case "position":
    					e._position(d);
    					break;
    		...
    		_size: function () {
    			...
    			this.element.show().css({
    				...
    				height: "auto",
    				width: b.width
    			}).outerHeight(), d = Math.max(0, b.minHeight - c);
    			if (b.height === "auto")
    		...
    		create: function (b) {
    			this.instances.length === 0 && (a("<div class='ui-helper-hidden-accessible' tabindex='0'></div>").focus(function (c) {
    				a(b.uiDialog.find(":tabbable").get().concat(b.uiDialog.get(0))).first().focus()
    			}).attr("id", "ui-dialog-overlay-start").prependTo(document.body).clone(!0).attr("id", "ui-dialog-overlay-end").appendTo(document.body), setTimeout(function () {
    				a.ui.dialog.overlay.instances.length && a(document.body).bind(a.ui.dialog.overlay.events, function (b) {
    			...
    			return c.appendTo(document.body).css({
    				width: this.width(),
    				height: this.height()
    		...
    		destroy: function (b) {
    			...
    			c !== -1 && this.oldInstances.push(this.instances.splice(c, 1)[0]), this.instances.length === 0 && (a([document, window]).unbind(".dialog-overlay"), a("#ui-dialog-overlay-start, #ui-dialog-overlay-end").remove()), b.height(0).width(0).remove();
    			var d = 0;
    		...
    		height: function () {
    			var b, c;
    			return a.browser.msie ? (b = Math.max(document.documentElement.scrollHeight, document.body.scrollHeight), c = Math.max(document.documentElement.offsetHeight, document.body.offsetHeight), b < c ? a(window).height() + "px" : b + "px") : a(document).height() + "px"
    		},
    		width: function () {
    			var b, c;
    ...
    function (a) {
    	...
    	a.widget("ui.menu", {
    		...
    		_create: function () {
    			this.activeMenu = this.element, this.menuId = this.element.attr("id") || "ui-menu-" + b++, this.element.find(".ui-icon").length && this.element.addClass("ui-menu-icons"), this.element.addClass("ui-menu ui-widget ui-widget-content ui-corner-all").attr({
    				id: this.menuId,
    				role: this.options.role,
    				tabIndex: 0
    			}).bind("click.menu", a.proxy(function (a) {
    				this.options.disabled && a.preventDefault()
    			}, this)), this.options.disabled && this.element.addClass("ui-state-disabled").attr("aria-disabled", "true"), this._bind({
    				...
    				"click .ui-menu-item:has(a)": function (b) {
    					var d = a(b.target);
    					d[0] !== c && (c = d[0], d.one("click.menu", function (a) {
    						c = null
    					}), d.closest(".ui-menu-item").is(".ui-state-disabled") || (this.select(b), this._delay(function () {
    				...
    				focus: function (b) {
    					var c = this.element,
                            d = c.children(".ui-menu-item").eq(0);
    					this._hasScroll() && !this.active ? c.children().each(function () {
    						var b = a(this);
    						if (b.offset().top - c.offset().top >= 0) return d = b, !1
    					}) : this.active && (d = this.active), this.focus(b, d)
    				},
    				blur: function (b) {
    					this._delay(function () {
    				...
    				keydown: "_keydown"
    			}), this.refresh(), this._bind(this.document, {
    				click: function (b) {
    		...
    		_destroy: function () {
    			this.element.removeAttr("aria-activedescendant").find(".ui-menu").andSelf().removeClass("ui-menu ui-widget ui-widget-content ui-corner-all").removeAttr("role").removeAttr("tabIndex").removeAttr("aria-labelledby").removeAttr("aria-expanded").removeAttr("aria-hidden").show(), this.element.find(".ui-menu-item").unbind(".menu").removeClass("ui-menu-item").removeAttr("role").children("a").removeClass("ui-corner-all ui-state-hover").removeAttr("tabIndex").removeAttr("role").removeAttr("aria-haspopup").removeAttr("id").children(".ui-icon").remove(), a(c).unbind("click.menu")
    		},
    		_keydown: function (b) {
    			switch (b.keyCode) {
    				case a.ui.keyCode.PAGE_UP:
    					this.previousPage(b), b.preventDefault();
    					break;
    				case a.ui.keyCode.PAGE_DOWN:
    					this.nextPage(b), b.preventDefault();
    					break;
    				case a.ui.keyCode.HOME:
    					this._move("first", "first", b), b.preventDefault();
    					break;
    				case a.ui.keyCode.END:
    					this._move("last", "last", b), b.preventDefault();
    					break;
    				case a.ui.keyCode.UP:
    					this.previous(b), b.preventDefault();
    					break;
    				case a.ui.keyCode.DOWN:
    					this.next(b), b.preventDefault();
    					break;
    				case a.ui.keyCode.LEFT:
    					this.collapse(b), b.preventDefault();
    					break;
    				case a.ui.keyCode.RIGHT:
    					this.active.is(".ui-state-disabled") || this.expand(b), b.preventDefault();
    					break;
    				case a.ui.keyCode.ENTER:
    					this.active.is(".ui-state-disabled") || (this.active.children("a[aria-haspopup='true']").length ? this.expand(b) : this.select(b)), b.preventDefault();
    					break;
    		...
    		refresh: function () {
    			...
    			b = d.add(this.element), b.children(":not( .ui-menu-item ):has( a )").addClass("ui-menu-item").attr("role", "presentation").children("a").addClass("ui-corner-all").attr("tabIndex", -1).attr("role", this._itemRole()).attr("id", function (a) {
    				return c + "-" + a
    			}), b.children(":not(.ui-menu-item)").addClass("ui-widget-content ui-menu-divider"), b.children(".ui-state-disabled").attr("aria-disabled", "true"), d.each(function () {
    				var b = a(this),
                        c = b.prev("a");
    		...
    		focus: function (b, c) {
    			var d, e, f, g, h, i, j, k;
    			this.blur(b, b && b.type === "focus"), this._hasScroll() && (e = parseFloat(a.css(this.activeMenu[0], "borderTopWidth")) || 0, f = parseFloat(a.css(this.activeMenu[0], "paddingTop")) || 0, g = c.offset().top - this.activeMenu.offset().top - e - f, h = this.activeMenu.scrollTop(), i = this.activeMenu.height(), j = c.height(), g < 0 ? this.activeMenu.scrollTop(h + g) : g + j > i && this.activeMenu.scrollTop(h + g - i + j)), this.active = c.first(), k = this.active.children("a").addClass("ui-state-focus"), this.options.role && this.element.attr("aria-activedescendant", k.attr("id")), this.active.parent().closest(".ui-menu-item").children("a:first").addClass("ui-state-active"), b.type === "keydown" ? this._close() : this.timer = this._delay(function () {
    				this._close()
    			}, this.delay), d = a("> .ui-menu", c), d.length && /^mouse/.test(b.type) && this._startOpening(d), this.activeMenu = c.parent(), this._trigger("focus", b, {
    				item: c
    			})
    		},
    		blur: function (a, b) {
    		...
    		_open: function (b) {
    			...
    			var c = a.extend({}, {
    				of: this.active
    			}, a.type(this.options.position) === "function" ? this.options.position(this.active) : this.options.position);
    		...
    		collapse: function (a) {
    			...
    			if (b && b.length) return this._close(), this.focus(a, b), !0
    		},
    		expand: function (a) {
    			var b = this.active && this.active.children(".ui-menu ").children(".ui-menu-item").first();
    			if (b && b.length) return this._open(b.parent()), this._delay(function () {
    				this.focus(a, b)
    			}, 20), !0
    		},
    		next: function (a) {
    		...
    		nextPage: function (b) {
    			...
    			if (this._hasScroll()) {
    				...
    				this.active.nextAll(".ui-menu-item").each(function () {
    					return e = a(this), a(this).offset().top - c - d < 0
    				}), this.focus(b, e)
    			} else this.focus(b, this.activeMenu.children(".ui-menu-item")[this.active ? "last" : "first"]())
    		},
    ...
    function (a) {
    	a.widget("ui.menubar", {
    		...
    		_create: function () {
    			var b = this;
    			this.menuItems = this.element.children(this.options.items), this.items = this.menuItems.children("button, a"), this.menuItems.addClass("ui-menubar-item").attr("role", "presentation"), this.items.slice(1).attr("tabIndex", -1), this.element.addClass("ui-menubar ui-widget-header ui-helper-clearfix").attr("role", "menubar"), this._focusable(this.items), this._hoverable(this.items), this.items.siblings(this.options.menuElement).menu({
    				position: {
    					within: this.options.position.within
    				},
    				select: function (c, d) {
    					d.item.parents("ul.ui-menu:last").hide(), b._close(), a(c.target).prev().focus(), b._trigger("select", c, d)
    				},
    				...
    				var d = a(this);
    				if (d.is(":hidden")) return;
    				switch (c.keyCode) {
    					case a.ui.keyCode.LEFT:
    						b.previous(c), c.preventDefault();
    						break;
    					case a.ui.keyCode.RIGHT:
    						b.next(c), c.preventDefault()
    				}
    			}), this.items.each(function () {
    				var c = a(this),
                        d = c.next(b.options.menuElement);
    				c.bind("click.menubar focus.menubar mouseenter.menubar", function (a) {
    					if (a.type == "focus" && !a.originalEvent) return;
    					a.preventDefault();
    					if (a.type == "click" && d.is(":visible") && b.active && b.active[0] == d[0]) {
    						b._close();
    						return
    					}
    					if (b.open && a.type == "mouseenter" || a.type == "click" || b.options.autoExpand) b.options.autoExpand && clearTimeout(b.closeTimer), b._open(a, d)
    				}).bind("keydown", function (c) {
    					switch (c.keyCode) {
    						case a.ui.keyCode.SPACE:
    						case a.ui.keyCode.UP:
    						case a.ui.keyCode.DOWN:
    							b._open(c, a(this).next()), c.preventDefault();
    							break;
    						case a.ui.keyCode.LEFT:
    							b.previous(c), c.preventDefault();
    							break;
    				...
    				}).addClass("ui-button ui-widget ui-button-text-only ui-menubar-link").attr("role", "menuitem").attr("aria-haspopup", "true").wrapInner("<span class='ui-button-text'></span>"), b.options.menuIcon && (c.addClass("ui-state-default").append("<span class='ui-button-icon-secondary ui-icon ui-icon-triangle-1-s'></span>"), c.removeClass("ui-button-text-only").addClass("ui-button-text-icon-secondary")), b.options.buttons || c.addClass("ui-menubar-link").removeClass("ui-state-default")
    			}), b._bind({
    				keydown: function (c) {
    					if (c.keyCode == a.ui.keyCode.ESCAPE && b.active && b.active.menu("collapse", c) !== !0) {
    						var d = b.active;
    						b.active.blur(), b._close(c), d.prev().focus()
    					}
    				},
    				focusin: function (a) {
    		...
    		_destroy: function () {
    			this.menuItems.removeClass("ui-menubar-item").removeAttr("role"), this.element.removeClass("ui-menubar ui-widget-header ui-helper-clearfix").removeAttr("role").unbind(".menubar"), this.items.unbind(".menubar").removeClass("ui-button ui-widget ui-button-text-only ui-menubar-link ui-state-default").removeAttr("role").removeAttr("aria-haspopup").children("span.ui-button-text").each(function (b, c) {
    				var d = a(this);
    				d.parent().html(d.html())
    			}).end().children(".ui-icon").remove(), this.element.find(":ui-menu").menu("destroy").show().removeAttr("aria-hidden").removeAttr("aria-expanded").removeAttr("tabindex").unbind(".menubar")
    		},
    		_close: function () {
    			...
    			this.active.menu("collapseAll").hide().attr({
    				"aria-hidden": "true",
    				"aria-expanded": "false"
    			}), this.active.prev().removeClass("ui-state-active").removeAttr("tabIndex"), this.active = null, this.open = !1
    		},
    		_open: function (b, c) {
    			if (this.active && this.active[0] == c[0]) return;
    			...
    			this.active = c.show().position(a.extend({
    				of: d
    			}, this.options.position)).removeAttr("aria-hidden").attr("aria-expanded", "true").menu("focus", b, c.children(".ui-menu-item").first()).focus().focusin(), this.open = !0
    		},
    		next: function (a) {
    			this._move("next", "first", a)
    		},
    		...
    		_move: function (b, c, d) {
    			var e, f;
    			this.open ? (e = this.active.closest(".ui-menubar-item")[b + "All"](this.options.items).first().children(".ui-menu").eq(0), f = this.menuItems[c]().children(".ui-menu").eq(0)) : d ? (e = a(d.target).closest(".ui-menubar-item")[b + "All"](this.options.items).children(".ui-menubar-link").eq(0), f = this.menuItems[c]().children(".ui-menubar-link").eq(0)) : e = f = this.menuItems.children("a").eq(0), e.length ? this.open ? this._open(d, e) : e.removeAttr("tabIndex")[0].focus() : this.open ? this._open(d, f) : f.removeAttr("tabIndex")[0].focus()
    		}
    	})
    } (jQuery),
    function (a) {
    	...
    	a.widget("ui.panel", {
    		...
    		_create: function () {
    			...
    			var c = this;
    			this.headers = this.element.find("> li > :first-child,> :not(li):even").addClass("ui-panel-header ui-helper-reset ui-state-default ui-corner-all").bind("mouseenter.panel", function () {
    				if (c.options.disabled) return;
    			...
    			}).bind("click.panel", function (b) {
    				if (c.options.disabled) return;
    				return c.click(a(this)), !1
    			}), this.headers.each(function (c, d) {
    				var e = a(this);
    				e.attr("id") || e.attr("id", "ui-panel-" + b++);
    				var f = e.hasClass("ui-state-active") ? "true" : "false";
    				e.add(e.next()).wrapAll("<div role='region' aria-labelledby='" + e.attr("id") + "' aria-expanded='" + f + "'></div>")
    			}), this._createIcons(), this.headers.next().addClass("ui-panel-content ui-helper-reset ui-widget-content ui-corner-bottom").hide()
    		},
    		destroy: function () {
    			...
    			var b = this.headers.next().css("display", "").removeAttr("role").removeClass("ui-helper-reset ui-widget-content ui-corner-bottom ui-panel-content ui-panel-content-active");
    			this.headers.unwrap()
    		},
    		_setOption: function (b, c) {
    			a.Widget.prototype._setOption.apply(this, arguments), b == "icons" ? (this._destroyIcons(), c && this._createIcons()) : b == "disabled" && this.headers.parent().attr("aria-disabled", c)
    		},
    		_createIcons: function () {
    			var b = this.options;
    			b.icons && (a("<span/>").addClass("ui-icon " + b.icons.header).prependTo(this.headers), this.headers.filter(".ui-state-active").find(".ui-icon").removeClass(b.icons.header).addClass(b.icons.headerSelected), this.element.addClass("ui-panel-icons"))
    		},
    		_destroyIcons: function () {
    			this.headers.children(".ui-icon").remove(), this.element.removeClass("ui-panel-icons")
    		},
    		click: function (a) {
    			a.toggleClass("ui-state-active ui-corner-top ui-corner-all").find(".ui-icon").toggleClass(this.options.icons.headerSelected).toggleClass(this.options.icons.header), a.next().slideToggle("fast").toggleClass("ui-panel-content-active").parent().attr("aria-expanded", a.hasClass("ui-state-active") ? "true" : "false")
    		}
    	})
    } (jQuery),
    function (a) {
    	...
    	a.widget("ui.popup", {
    		...
    		_create: function () {
    			this.options.trigger || (this.options.trigger = this.element.prev()), this.element.attr("id") || (this.element.attr("id", "ui-popup-" + b++), this.generatedId = !0), this.element.attr("role") || this.options.managed || (this.element.attr("role", "dialog"), this.generatedRole = !0), this.options.trigger.attr("aria-haspopup", "true").attr("aria-owns", this.element.attr("id")), this.element.addClass("ui-popup"), this._beforeClose(), this.element.hide(), this._bind(this.options.trigger, {
    				keydown: function (b) {
    					switch (b.keyCode) {
    						case a.ui.keyCode.TAB:
    							this.element.hide(), this.close(b);
    							break;
    						case a.ui.keyCode.ESCAPE:
    							this.isOpen && this.close(b);
    							break;
    						case a.ui.keyCode.SPACE:
    							this.options.trigger.is("a:ui-button") ? b.preventDefault() : this.options.trigger.is("a:not(:ui-button)") && this.options.trigger.trigger("click", b);
    							break;
    						case a.ui.keyCode.DOWN:
    						case a.ui.keyCode.UP:
    							b.preventDefault(), clearTimeout(this.closeTimer), this._delay(function () {
    								this.open(b), this.focusPopup(b)
    							}, 1)
    					}
    				},
    				click: function (a) {
    				...
    				mousedown: function (b) {
    					var d = !1;
    					a(b.target).is("input") && (d = !0);
    					if (this.isOpen) {
    						c = !0, this.close();
    						return
    					}
    					this.open(b), clearTimeout(this.closeTimer), this._delay(function () {
    						d || this.focusPopup()
    					}, 1)
    				}
    			}), this.options.expandOnFocus && this._bind(this.options.trigger, {
    				focus: function (a) {
    					c || this._delay(function () {
    						this.isOpen || this.open(a)
    					}, 1), this._delay(function () {
    						c = !1
    					}, 100)
    				},
    				blur: function (a) {
    			...
    			}), this.options.managed || this._bind({
    				keydown: function (b) {
    					if (b.keyCode !== a.ui.keyCode.TAB) return;
    					var c = a(":tabbable", this.element),
                            d = c.first(),
                            e = c.last();
    					b.target === e[0] && !b.shiftKey ? (d.focus(1), b.preventDefault()) : b.target === d[0] && b.shiftKey && (e.focus(1), b.preventDefault())
    				}
    			}), this._bind({
    				focusout: function (a) {
    				...
    				keyup: function (b) {
    					b.keyCode == a.ui.keyCode.ESCAPE && this.element.is(":visible") && (this.close(b), this.focusTrigger())
    				}
    			}), this._bind(this.document, {
    				click: function (b) {
    					this.isOpen && !a(b.target).closest(this.element.add(this.options.trigger)).length && this.close(b)
    				}
    			})
    		},
    		_destroy: function () {
    			this.element.show().removeClass("ui-popup").removeAttr("aria-hidden").removeAttr("aria-expanded").unbind("keypress.ui-popup"), this.options.trigger.removeAttr("aria-haspopup").removeAttr("aria-owns"), this.generatedId && this.element.removeAttr("id"), this.generatedRole && this.element.removeAttr("role")
    		},
    		open: function (b) {
    			var c = a.extend({}, {
    				of: this.options.trigger
    			}, this.options.position);
    			this._show(this.element, this.options.show), this.element.attr("aria-hidden", "false").attr("aria-expanded", "true").position(c), this.options.trigger.attr("tabindex", -1), this.isOpen = !0, this._trigger("open", b)
    		},
    		focusPopup: function (a) {
    			if (!this.options.managed) {
    				var b = this.element.find(":tabbable");
    				this.removeTabIndex = !1, b.length || (this.element.is(":tabbable") || (this.element.attr("tabindex", "0"), this.removeTabIndex = !0), b = b.add(this.element[0])), b.first().focus(1)
    			}
    			this._trigger("focusPopup", a)
    		},
    		focusTrigger: function (a) {
    			c = !0, this.options.trigger.focus(), this._trigger("focusTrigger", a)
    		},
    		close: function (a) {
    			this._beforeClose(), this._hide(this.element, this.options.hide), this.options.trigger.attr("tabindex", 0), this.removeTabIndex && this.element.removeAttr("tabindex"), this.isOpen = !1, this._trigger("close", a)
    		},
    ...
    function (a, b) {
    	...
    	a.position = {
    		...
    		var c, k, o, p, q, r = a(b.of),
                    ...
                    w = {};
    		return u.nodeType === 9 ? (k = r.width(), o = r.height(), p = {
    			top: 0,
    			left: 0
    		...
    		flip: {
    			left: function (a, b) {
    				var c = b.within,
                            ...
                            f = c.width,
                            g = c.isWindow ? 0 : c.offset.left,
                            h = a.left - b.collisionPosition.marginLeft,
                            i = h - g,
                            j = h + b.collisionWidth - f - g,
                            k = b.my[0] === "left" ? -b.elemWidth : b.my[0] === "right" ? b.elemWidth : 0,
                            l = b.at[0] === "left" ? b.targetWidth : b.at[0] === "right" ? -b.targetWidth : 0,
                            m = -2 * b.offset[0],
                            n, o;
    				if (i < 0) {
    			...
    			top: function (a, b) {
    				var c = b.within,
                            ...
                            f = c.height,
                            g = c.isWindow ? 0 : c.offset.top,
                            h = a.top - b.collisionPosition.marginTop,
                            i = h - g,
                            j = h + b.collisionHeight - f - g,
                            k = b.my[1] === "top",
                            l = k ? -b.elemHeight : b.my[1] === "bottom" ? b.elemHeight : 0,
                            m = b.at[1] === "top" ? b.targetHeight : b.at[1] === "bottom" ? -b.targetHeight : 0,
                            n = -2 * b.offset[1],
                            o, p;
            ...
            function () {
            	...
            	a.fn.position = function (d) {
            		...
            		var e = d.offset.split(" "),
                        f = d.at.split(" ");
            		return e.length === 1 && (e[1] = e[0]), /^\d/.test(e[0]) && (e[0] = "+" + e[0]), /^\d/.test(e[1]) && (e[1] = "+" + e[1]), f.length === 1 && (/left|center|right/.test(f[0]) ? f[1] = "center" : (f[1] = f[0], f[0] = "center")), c.call(this, a.extend(d, {
            			at: f[0] + e[0] + " " + f[1] + e[1],
            			offset: b
            		}))
            	}
    ...
    function (a, b) {
    	a.widget("ui.progressbar", {
    		...
    		_create: function () {
    			...
    			}), this.valueDiv = a("<div class='ui-progressbar-value ui-widget-header ui-corner-left'></div>").appendTo(this.element), this.oldValue = this._value(), a.support.highContrast && (this.valueDiv.css("right", "0%"), this.valueTextDiv = a("<span class='ui-progressbar-valuetext'>" + this._value() + "</span>").appendTo(this.element)), this._refreshValue()
    		},
    		_destroy: function () {
    ...
    function (a, b) {
    	...
    	a.widget("ui.slider", a.ui.mouse, {
    		...
    		_create: function () {
    			...
    			for (b = e.length; b < g; b++) h.push(f);
    			this.handles = e.add(a(h.join("")).appendTo(this.element)), this.handle = this.handles.eq(0), this.handles.add(this.range).filter("a").click(function (a) {
    				a.preventDefault()
    			}).hover(function () {
    				...
    				a(this).data("ui-slider-handle-index", b).attr("aria-valuenow", d.values ? d.values[b] : d.value), i.options.unittext && a(this).data("index.ui-slider-handle", b).attr("aria-valuetext", (d.values ? d.values[b] : d.value) + " " + i.options.unittext)
    			...
    			if (this.handles.length > 1) {
    				var k = "";
    				d.label ? this.handles.each(function (b, c) {
    					k = d.range && b < 2 ? b == 0 ? "minimum" : "maximum" : b + 1, a(this).attr("title", d.label + " " + k)
    				}) : d.labels && this.handles.each(function (b, c) {
    					d.labels[b] && a(this).attr("title", d.labels[b])
    				})
    			} else d.label && (j.title = d.label);
    			this.handles.attr(j), this._refreshValue(), this._animateOff = !1, this._updateAriaLimit("min"), this._updateAriaLimit("max")
    		},
    		_destroy: function () {
    		...
    		_slide: function (b, c, d) {
    			var e = this.handles[c],
                    f, g, h;
    			this.options.values && this.options.values.length ? (f = this.values(c ? 0 : 1), this.options.values.length === 2 && this.options.range === !0 && (c === 0 && d > f || c === 1 && d < f) && (d = f), d !== this.values(c) && (g = this.values(), g[c] = d, h = this._trigger("slide", b, {
    				handle: this.handles[c],
    				value: d,
    				values: g
    			}), f = this.values(c ? 0 : 1), h !== !1 && (this.values(c, d, !0), a(e).attr("aria-valuenow", d), this.options.unittext && a(e).attr("aria-valuetext", d + " " + this.options.unittext)))) : d !== this.value() && (h = this._trigger("slide", b, {
    				handle: this.handles[c],
    				value: d
    			}), h !== !1 && (this.value(d), a(e).attr("aria-valuenow", d), this.options.unittext && a(e).attr("aria-valuetext", d + " " + this.options.unittext)))
    		},
    		_stop: function (a, b) {
    			var c = {
    				handle: this.handles[b],
    		...
    		_refreshValue: function () {
    			...
    			this.options.values && this.options.values.length ? this.handles.each(function (d, e) {
    				c = (i.values(d) - i._valueMin()) / (i._valueMax() - i._valueMin()) * 100, k[i.orientation === "horizontal" ? "left" : "bottom"] = c + "%", a(this).stop(1, 1)[j ? "animate" : "css"](k, h.animate), i.options.range === !0 && (i.orientation === "horizontal" ? (d === 0 && i.range.stop(1, 1)[j ? "animate" : "css"]({
    					left: c + "%"
    				}, h.animate), d === 1 && i.range[j ? "animate" : "css"]({
    					width: c - b + "%"
    				}, {
    					queue: !1,
    					duration: h.animate
    				})) : (d === 0 && i.range.stop(1, 1)[j ? "animate" : "css"]({
    					bottom: c + "%"
    				}, h.animate), d === 1 && i.range[j ? "animate" : "css"]({
    					height: c - b + "%"
    				}, {
    					queue: !1,
    					duration: h.animate
    				}))), b = c, a(this).attr("aria-valuenow", l.values(d)), l.options.range && d < 2 && l.handles.eq(d == 0 ? 1 : 0).attr(d == 0 ? "aria-valuemin" : "aria-valuemax", l.values(d))
    			}) : (d = this.value(), e = this._valueMin(), f = this._valueMax(), c = f !== e ? (d - e) / (f - e) * 100 : 0, k[this.orientation === "horizontal" ? "left" : "bottom"] = c + "%", this.handle.stop(1, 1)[j ? "animate" : "css"](k, h.animate), g === "min" && this.orientation === "horizontal" && this.range.stop(1, 1)[j ? "animate" : "css"]({
    				width: c + "%"
    			}, h.animate), g === "max" && this.orientation === "horizontal" && this.range[j ? "animate" : "css"]({
    				width: 100 - c + "%"
    			}, {
    				queue: !1,
    				duration: h.animate
    			}), g === "min" && this.orientation === "vertical" && this.range.stop(1, 1)[j ? "animate" : "css"]({
    				height: c + "%"
    			}, h.animate), g === "max" && this.orientation === "vertical" && this.range[j ? "animate" : "css"]({
    				height: 100 - c + "%"
    			}, {
    				queue: !1,
    				duration: h.animate
    			}), this.handle.attr("aria-valuenow", d))
    		},
    		_updateAriaLimit: function (b) {
    			var c = this.options[b];
    			this.range && this.options.values && this.options.values.length == 2 ? this.handles.eq(b == "min" ? 0 : 1).attr(b == "min" ? "aria-valuemin" : "aria-valuemax", c) : this.handles.each(function (d) {
    				a(this).attr(b == "min" ? "aria-valuemin" : "aria-valuemax", c)
    			})
    		}
    	})
    } (jQuery),
    function (a) {
    	...
    	a.widget("ui.spinner", {
    		...
    		_create: function () {
    			this._setOption("max", this.options.max), this._setOption("min", this.options.min), this._setOption("step", this.options.step), this._value(this.element.val(), !0), this._draw(), this._bind(this._events), this._refresh(), this._bind(this.window, {
    				beforeunload: function () {
    					this.element.removeAttr("autocomplete")
    				}
    			})
    ...
    function (a, b) {
    	...
    	var c = 0,
            d = /#.*$/,
            f = function (a) {
            	return a = a.cloneNode(!1), a.hash.length > 1 && a.href.replace(d, "") === location.href.replace(d, "")
            };
    	a.widget("ui.tabs", {
    		version: "@VERSION",
    		options: {
    		...
    		_create: function () {
    			var c = this,
                    d = c.options,
                    e = d.active;
    			c.running = !1, c.element.addClass("ui-tabs ui-widget ui-widget-content ui-corner-all"), c._processTabs();
    			if (e === null) {
    				location.hash && c.anchors.each(function (a, b) {
    					if (b.hash === location.hash) return e = a, !1
    				}), e === null && (e = c.lis.filter(".ui-tabs-active").index());
    				if (e === null || e === -1) e = c.lis.length ? 0 : !1
    			}
    			e !== !1 && (e = this.lis.eq(e).index(), e === -1 && (e = d.collapsible ? !1 : 0)), d.active = e, !d.collapsible && d.active === !1 && this.anchors.length && (d.active = 0), a.isArray(d.disabled) && (d.disabled = a.unique(d.disabled.concat(a.map(this.lis.filter(".ui-state-disabled"), function (a, b) {
    				return c.lis.index(a)
    			}))).sort()), this._setupFx(d.fx), this._refresh(), this.panels.hide().attr("aria-hidden", "true"), this.lis.removeClass("ui-tabs-active ui-state-active");
    			if (d.active !== !1 && this.anchors.length) {
    				this.active = this._findActive(d.active);
    				var f = c._getPanelForTab(this.active);
    				f.show(), this.lis.eq(d.active).addClass("ui-tabs-active ui-state-active").children("a").attr("aria-selected", "true").attr("tabindex", "0"), this.load(d.active)
    			} else this.active = a();
    			this.list.bind(a.browser.mozilla ? "keypress.tabs" : "keydown.tabs", function (e) {
    				if (e.keyCode < a.ui.keyCode.PAGE_UP || e.keyCode > a.ui.keyCode.DOWN) return;
    				var f, g = !0;
    				switch (e.keyCode) {
    					case a.ui.keyCode.RIGHT:
    						e.preventDefault(), f = d.selected + 1;
    						break;
    					case a.ui.keyCode.DOWN:
    						f = d.selected + 1;
    						break;
    				...
    				if (f !== b) {
    					f = f >= c.anchors.length ? 0 : f < 0 ? c.anchors.length - 1 : f;
    					var h = !0;
    					if (a.inArray(f, d.disabled) !== -1) {
    						h = !1;
    						for (var i = 0; i < c.anchors.length; i++) {
    							f = g ? f + 1 : f - 1, f = f >= c.anchors.length ? 0 : f < 0 ? c.anchors.length - 1 : f;
    							if (a.inArray(f, d.disabled) == -1) {
    								h = !0;
    								break
    							}
    					...
    					h && (c.select(f), c.anchors.eq(f).focus())
    				}
    				return !1
    			}), this.panels.bind(a.browser.mozilla ? "keypress.tabs" : "keydown.tabs", function (b) {
    				if (b.keyCode != a.ui.keyCode.PAGE_UP && b.keyCode != a.ui.keyCode.PAGE_DOWN || !b.ctrlKey) return;
    				var d = b.keyCode == a.ui.keyCode.PAGE_UP,
                        e = new a.Event(a.browser.mozilla ? "keypress" : "keydown");
    				return e.keyCode = d ? a.ui.keyCode.RIGHT : a.ui.keyCode.LEFT, c.active.trigger(e), !1
    			})
    		},
    		_getCreateEventData: function () {
    			return {
    		...
    		refresh: function () {
    			...
    			if (c.active === !1 || !this.anchors.length) c.active = !1, this.active = a();
    			else if (this.active.length && !a.contains(this.list[0], this.active[0])) {
    				var e = c.active - 1;
    				this._activate(e >= 0 ? e : 0)
    			} else c.active = this.anchors.index(this.active)
    		},
    		_refresh: function () {
    			var a = this.options;
    		...
    		_processTabs: function () {
    			var b = this;
    			this.list = this._getList(), this.list.attr("role", "tablist"), this.lis = a(" > li:has(a[href])", this.list), this.lis.attr("role", "presentation"), this.anchors = this.lis.map(function () {
    				return a("a", this)[0]
    			}), this.panels = a([]), this.anchors.each(function (c, d) {
    				var e, g;
    				if (f(d)) e = d.hash, g = b.element.find(b._sanitizeSelector(e));
    				else {
    					var h = b._tabId(d);
    					e = "#" + h, g = b.element.find(e), g.length || (g = b._createPanel(h), g.insertAfter(b.panels[c - 1] || b.list))
    				}
    				g.length && (g.attr("role", "tabpanel").attr("aria-hidden", "true").attr("aria-expanded", "false"), b.panels = b.panels.add(g)), a(d).attr("aria-controls", e.substring(1)).attr("role", "tab").attr("aria-selected", "false").attr("tabindex", "-1"), d.id || a(d).attr("id", b._tabId(d) + "-tab"), a("#" + a(d).attr("aria-controls")).attr("aria-labelledby", d.id)
    			})
    		},
    		_getList: function () {
    		...
    		_setupDisabled: function (b) {
    			...
    			for (var c = 0, d; d = this.lis[c]; c++) a(d).toggleClass("ui-state-disabled", b === !0 || a.inArray(c, b) !== -1);
    		...
    		_eventHandler: function (b) {
    			var c = this,
                    ...
                    g = f[0] === e[0],
                    h = g && d.collapsible,
                    i = h ? a() : c._getPanelForTab(f),
                    j = e.length ? c._getPanelForTab(e) : a(),
                    k = f.closest("li"),
                    l = {
                    	oldTab: e,
                    	oldPanel: j,
    			...
    			if (!j.length && !i.length) throw "jQuery UI Tabs: Mismatching fragment identifier.";
    		...
    		_toggle: function (b, c) {
    			...
    			function i() {
    				c.newTab.attr("aria-selected", "true").attr("tabindex", "0").closest("li").addClass("ui-tabs-active ui-state-active"), f.attr("aria-hidden", "false").attr("aria-expanded", "true"), c.newTab.closest("li").addClass("ui-tabs-active ui-state-active"), c.newTab.attr("aria-selected", "true").attr("tabindex", "0").closest("li").addClass("ui-tabs-active ui-state-active"), f.attr("aria-hidden", "false").attr("aria-expanded", "true"), f.length && d.showFx ? f.animate(d.showFx, d.showFx.duration || "normal", function () {
    			...
    			var d = this,
                    ...
                    f = c.newPanel,
                    g = c.oldPanel;
    			d.running = !0, g.attr("aria-hidden", "true").attr("aria-expanded", "false"), c.oldTab.attr("aria-selected", "false").attr("tabindex", "-1"), g.length && d.hideFx ? g.animate(d.hideFx, d.hideFx.duration || "normal", function () {
    		...
    		_destroy: function () {
    			var b = this.options;
    			return this.xhr && this.xhr.abort(), this.element.removeClass("ui-tabs ui-widget ui-widget-content ui-corner-all ui-tabs-collapsible"), this.list.removeClass("ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all").removeAttr("role").unbind(".tabs"), this.anchors.unbind(".tabs").removeData("href.tabs").removeData("load.tabs").removeAttr("role").removeAttr("aria-selected").removeAttr("aria-controls").removeAttr("tabindex"), this.lis.unbind(".tabs").add(this.panels).removeAttr("role").each(function () {
    			...
    			}), this.panels.show().removeAttr("aria-hidden").removeAttr("aria-expanded").removeAttr("aria-labelledby").unbind(".tabs"), this
    		},
    		enable: function (c) {
    		...
    		load: function (b, c) {
    			...
    			var d = this,
                    e = this.options,
                    g = this.anchors.eq(b),
                    h = d._getPanelForTab(g),
                    i = {
                    	tab: g,
                    	panel: h
                    };
    			if (f(g[0])) return;
    			return this.xhr = a.ajax({
    				url: g.attr("href"),
    	...
    	if (a.uiBackCompat !== !1) {
    		a.ui.tabs.prototype._ui = function (a, b) {
    			...
    			add: function (c, d, e) {
    				...
    				var f = this.options,
                        g = a(f.tabTemplate.replace(/#\{href\}/g, c).replace(/#\{label\}/g, d)),
                        h = c.indexOf("#") ? this._tabId(g.find("a")[0]) : c.replace("#", "");
    				g.addClass("ui-state-default ui-corner-top").data("ui-tabs-destroy", !0), g.find("a").attr("aria-controls", h);
    				var i = e >= this.lis.length,
                        j = this.element.find("#" + h);
    				return j.length || (j = this._createPanel(h), i ? e > 0 ? j.insertAfter(this.panels.eq(-1)) : j.appendTo(this.element) : j.insertBefore(this.panels[e])), j.addClass("ui-tabs-panel ui-widget-content ui-corner-bottom").hide().attr("aria-hidden", "true"), i ? g.appendTo(this.list) : g.insertBefore(this.lis[e]), f.disabled = a.map(f.disabled, function (a) {
    					return a >= e ? ++a : a
    				}), this.refresh(), this.lis.length === 1 && f.active === !1 && this.option("active", 0), this._trigger("add", null, this._ui(this.anchors[e], this.panels[e])), this
    			},
    			remove: function (b) {
    				b = this._getIndex(b);
    				var c = this.options,
                        d = this.lis.eq(b).remove(),
                        e = this._getPanelForTab(d.find("a[aria-controls]")).remove();
    			...
    			_trigger: function (a, b, c) {
    				...
    				return d ? (a === "beforeActivate" && c.newTab.length ? d = this._super("select", b, {
    					tab: c.newTab[0],
    					panel: c.newPanel[0],
    					index: c.newTab.closest("li").index()
    				}) : a === "activate" && c.newTab.length && (d = this._super("show", b, {
    					tab: c.newTab[0],
    					panel: c.newPanel[0],
    					index: c.newTab.closest("li").index()
    				})), d) : !1
    		...
    		a.widget("ui.tabs", a.ui.tabs, {
    			...
    			_cookie: function (b) {
    				...
    				return arguments.length && (c.push(b === !1 ? -1 : b), c.push(this.options.cookie)), a.cookie.apply(null, c)
    			},
    			_refresh: function () {
    			...
    			_trigger: function (b, c, d) {
    				var e = a.extend({}, d);
    				return b === "load" && (e.panel = e.panel[0], e.tab = e.tab[0]), this._super(b, c, e)
    			}
    		})
    	}
    } (jQuery),
    function (a) {
    	...
    	a.widget("ui.tooltip", {
    		...
    		_setOption: function (a, b) {
    			if (a === "disabled") {
    				this[b ? "_disable" : "_enable"](), this.options[a] = b;
    				return
    			}
    			this._super(a, b)
    		},
    		...
    		open: function (b) {
    			...
    			if (!e.length || e.attr("aria-describedby")) return;
    			e.attr("title") && e.data("ui-tooltip-title", e.attr("title")), e.data("tooltip-open", !0), c = this.options.content.call(e[0], function (a) {
    		...
    		_open: function (b, c, d) {
    			if (!d) return;
    			c.is("[title]") && (b && b.type === "mouseover" ? c.attr("title", "") : c.removeAttr("title"));
    			var e = this._find(c);
    			e.length || (e = this._tooltip(c), c.attr("aria-describedby", e.attr("id"))), e.find(".ui-tooltip-content").html(d), e.stop(!0).position(a.extend({
    				of: c
    			}, this.options.position)).hide(), this._show(e, this.options.show), this._trigger("open", b, {
    				tooltip: e
    			}), this._bind(c, {
    				mouseleave: "close",
    				focusout: "close",
    		...
    		close: function (b, c) {
    			...
    			if (!c && b && b.type !== "focusout" && this.document[0].activeElement === e[0]) return;
    			...
    			}), e.removeData("tooltip-open"), e.unbind("mouseleave.tooltip focusout.tooltip keyup.tooltip"), this.closing = !0, this._trigger("close", b, {
    				tooltip: f
    			}), this.closing = !1
    		},
    		_tooltip: function (c) {
